        ...
        <table class="table">
            ...
            <tbody id = "cp_tbody">
                    ...
                    @foreach($capaianPembelajaran as $key => $v)
                        <tr id="R0"> 
                            <td class="row-index text-center"> 
                                <textarea class = "form-control cp_text" name = "capaian_pembelajaran[]"  >{{ $v }}</textarea>
                            </td> 
                ...
                @else
                    <tr id="R0"> 
                        <td class="row-index text-center"> 
                            <textarea required  class = "form-control cp_text" name = "capaian_pembelajaran[]" ></textarea>
                        </td> 
                        <td class="text-center"> 
    ...
    $(document).ready(function(){
        ...
        $("#button_cp").on("click",function(){
           $('#cp_tbody').append(`<tr id="R${++rowIdx}"> 
                    <td class="row-index text-center"> 
                        <textarea class = "form-control cp_text" required name = "capaian_pembelajaran[]" class = "cp_text" ></textarea>
                    </td> 
                    <td class="text-center"> 
                        <button type = "button" class = "btn btn-danger btn-sm remove_cp">X</button>
                    </td> 
